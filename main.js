...
class DomController {
    ...
    viewOnlyToday() {
        ...
        for (const task of Object.values(_Logic__WEBPACK_IMPORTED_MODULE_0__.currentList.tasks).filter(list => {
